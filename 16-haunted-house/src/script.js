...
//repeat texture - why? because the texture is too small for the plane
...
const floor = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    transparent: true, // this is important for the alphaMap to work
...
walls.position.y += 1.25; // += isnt important here, but it is good practice default is 0
house.add(walls);
